    ...
    def __init__(
        ...
        *,
        ...
        if self.input_is_xarray:
            ...
            self.input_paths = input_data if isinstance(input_data, list) else [input_data] if input_data else []
        ...
        if table in ("Amon", "Lmon", "Emon"):
            self.cmoriser = CMIP6_Atmosphere_CMORiser(
                input_data=self.input_dataset if self.input_is_xarray else self.input_paths,
