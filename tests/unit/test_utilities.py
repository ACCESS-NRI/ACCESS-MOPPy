...
from access_moppy.utilities import (
    ...
    _infer_frequency,
    _calculate_monthly_bounds,
    _calculate_daily_bounds,
    _calculate_yearly_bounds,
    _calculate_midpoint_bounds,
)
...
class TestCalculateTimeBoundsMonthly:
    ...
    def test_monthly_bounds_numpy_datetime64(self):
        ...
        time = np.array([
            '2000-01-15', '2000-02-15', '2000-03-15',
    ...
    def test_monthly_bounds_year_2200(self):
        ...
        time = xr.cftime_range('2200-01-15', periods=12, freq='MS', calendar='proleptic_gregorian')
        ds = xr.Dataset(coords={'time': time})
...
class TestInferFrequency:
    ...
    def test_infer_frequency_irregular(self):
        ...
        time_values = np.array([
            '2000-01-01', '2000-01-05', '2000-01-12'
        ], dtype='datetime64[D]')
    ...
    def test_different_calendars(self):
        ...
        for calendar in calendars:
            ...
            if 'calendar' in time_bnds.attrs:
                assert time_bnds.attrs['calendar'] in [calendar, expected_calendars.get(calendar, calendar)]
    
    def test_long_time_series(self):
        """Test with a long time series (performance check)."""
        time = xr.cftime_range('0000-01', periods=100, freq='MS', calendar='proleptic_gregorian')
        ds = xr.Dataset(coords={'time': time})
